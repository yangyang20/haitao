    ...
    <div class="layui-row layui-col-space15 ">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">修改产品</div>
                <div class="layui-card-body">
                    <form class="layui-form main">
                        <div class="layui-form-item">
                            <label class="layui-form-label">产品名称</label>
                            <div class="layui-input-block">
                                <input type="text" name="goods_name" value="{{$goodsInfo->goods_name}}" lay-verify="required" placeholder="请输入产品名称" autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="brand_id" lay-verify="required">
                                    ...
                                    <option value="{{$item->id}}" {{$goodsInfo->brand_id == $item->id ? 'selected':''}}>{{$item->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
<script>
    layui.define(['form'], function () {
        ...
        form.on('submit(*)', function (data) {
            $.ajax({
                url: '{{url("admin/goods/{$goodsInfo->id}")}}',
                type: "put",
                data: data.field,
                dataType: 'json',
